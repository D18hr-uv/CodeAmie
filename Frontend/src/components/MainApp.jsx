...
function MainApp() {
  ...
  const saveCode = async () => {
    ...
    const toastId = toast.loading('Saving your code...');
    ...
    try {
      ...
      toast.success(<b>Code saved to your history!</b>, { id: toastId });
    } catch (error) {
      console.error("Error saving code:", error);
      toast.error(<b>Could not save your code.</b>, { id: toastId });
    }
  };
